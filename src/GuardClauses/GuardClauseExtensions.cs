...
namespace Ardalis.GuardClauses
{
    ...
    public static class GuardClauseExtensions
    {
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentException"></exception>
        public static string InvalidFormat([JetBrainsNotNull] this IGuardClause guardClause, [JetBrainsNotNull] string input, [JetBrainsNotNull][JetBrainsInvokerParameterName] string parameterName, [JetBrainsNotNull] string regexPattern, string? message = null)
        {
