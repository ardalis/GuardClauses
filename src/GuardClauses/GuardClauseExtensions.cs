...
using JetBrainsCanBeNullAttribute = JetBrains.Annotations.CanBeNullAttribute;
...
namespace Ardalis.GuardClauses
{
    ...
    public static class GuardClauseExtensions
    {
        ...
        public static DateTime NullOrOutOfSQLDateRange([JetBrainsNotNull] this IGuardClause guardClause, DateTime? input, [JetBrainsNotNull][JetBrainsInvokerParameterName] string parameterName, string? message = null)
        {
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public static T NullOrOutOfRange<T>([JetBrainsNotNull] this IGuardClause guardClause, [NotNull, JetBrainsCanBeNull][ValidatedNotNull] T? input, [JetBrainsNotNull][JetBrainsInvokerParameterName] string parameterName, [NotNull, JetBrainsNotNull][ValidatedNotNull] T rangeFrom, [NotNull, JetBrainsNotNull][ValidatedNotNull] T rangeTo, string? message = null) where T : struct, IComparable<T>
        {
            guardClause.Null(input, nameof(input));
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        private static T NullOrOutOfRangeInternal<T>([JetBrainsNotNull] this IGuardClause guardClause, [NotNull, JetBrainsNotNull][ValidatedNotNull] T? input, [JetBrainsNotNull][JetBrainsInvokerParameterName] string parameterName, [NotNull, JetBrainsNotNull][ValidatedNotNull] T? rangeFrom, [NotNull, JetBrainsNotNull][ValidatedNotNull] T? rangeTo, string? message = null) where T : IComparable<T>?
        {
            Guard.Against.Null(input, nameof(input));
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public static IEnumerable<T> OutOfRange<T>([JetBrainsNotNull] this IGuardClause guardClause, IEnumerable<T> input, [JetBrainsNotNull][JetBrainsInvokerParameterName] string parameterName, T rangeFrom, T rangeTo, string? message = null) where T : IComparable, IComparable<T>
        {
            if (rangeFrom.CompareTo(rangeTo) > 0)
            {
                throw new ArgumentException(message ?? $"{nameof(rangeFrom)} should be less or equal than {nameof(rangeTo)}");
